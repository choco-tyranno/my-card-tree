...
public class SpreadingOutDetailOnClickListener implements OnClickListener {
    ...
    public void onClick(View view) {
        ...
        com.choco_tyranno.team_tree.ui.card_rv.CardRecyclerView cardRecyclerView = (CardRecyclerView) cardFrame.getParent();
        com.choco_tyranno.team_tree.ui.card_rv.ContactCardViewHolder cardViewHolder = (ContactCardViewHolder) cardRecyclerView.getChildViewHolder(cardFrame);
        ...
        com.choco_tyranno.team_tree.ui.main.MainCardActivity mainCardActivity =((MainCardActivity)view.getContext());
