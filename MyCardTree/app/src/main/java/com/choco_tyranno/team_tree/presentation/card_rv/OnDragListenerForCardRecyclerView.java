...
public class OnDragListenerForCardRecyclerView implements View.OnDragListener {
    ...
    private boolean handleCreateServiceSingleItemVisibleCase(CardRecyclerView view, int firstVisibleItemPosition, DragEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case DragEvent.ACTION_DRAG_EXITED:
                animateCard(firstVisibleItemCardFrameLayout, true, CARD_LOCATION_LEFT);
                return true;
            case DragEvent.ACTION_DROP:
                animateCard(firstVisibleItemCardFrameLayout, true, CARD_LOCATION_LEFT);
                createCard(view, firstVisibleItemCardFrameLayout);
                return true;
        }
        return false;
    }
    ...
    private void createCard(CardRecyclerView cardRecyclerView, FrameLayout firstVisibleItemCardFrameLayout) {
        ...
        ItemCardFrameBinding cardFrameBinding = ((ContactCardViewHolder) cardRecyclerView.getChildViewHolder(firstVisibleItemCardFrameLayout)).getBinding();
...
//            }, cardRecyclerView.getContext());
    ...
    private boolean handleMoveServiceDragEndedEvent(CardRecyclerView cardRecyclerView) {
        ...
        cardRecyclerView.setOnDragMove(false);
